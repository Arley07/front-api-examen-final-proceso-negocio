            ...
            for(const articulo of data){
                ...
                articulos += `
                        ...
                        <tr>
                            ...
                            <td>ID:${articulo.categoria.id},NOMBRE:${articulo.categoria.nombreca}</td>
...
function verModificarArticulo(codigo){
    ...
    .then(function(articulo){
            ...
            document.getElementById("contentModal-1").innerHTML = cadena;
...
async function modificarArticulo(codigo) {
    ...
    document.getElementById("contentModal-1").innerHTML = "";
